...
const renderButtonByStatus = (status?: ReservationStatusEnum | null) => {
  ...
  switch (status) {
    ...
    case ReservationStatusEnum.AVAILABLE:
      return (
        <div className="w-full md:w-1/5 flex justify-end items-start">
    ...
    <>
      ...
      <section>
        ...
        >
          <button
            onClick={() => navigate(-1)}
            className="w-1/2 flex items-center justify-start shadow-none text-neutral-100"
          >
            <MdOutlineArrowBackIos size={24} />
          </button>
          <div className="w-3/4 flex md:items-center gap-2">
      ...
      <section className="bg-neutral-800 min-h-[calc(100vh-200px)] md:h-[calc(100vh-64px)] w-full flex flex-col items-center">
        <div
          className={`w-full md:w-1/2 flex ${
            court?.reservation?.contactPhone ? "justify-between" : "justify-end"
          } bg-neutral-900 mt-2 border-b-2 border-primary-500 md:gap-8 p-2 px-4 rounded-t-sm`}
        >
        ...
        <div className="bg-neutral-900 w-full md:w-1/2 flex flex-col items-center justify-center p-4 rounded-sm">
          ...
          {court?.status === ReservationStatusEnum.PREPAID && (
            <section className="w-full flex flex-col justify-center items-center mt-4">
              <div className="flex justify-center gap-2 bg-warning-500 text-neutral-800 p-4 w-full shadow-md">
                <div className="flex w-full justify-center items-start text-center gap-2">
          ...
          {court?.status === ReservationStatusEnum.AVAILABLE && (
            <form className="flex flex-col justify-center items-center px-4 mt-4 w-full">
              <Input
                name="name"
                title="Nome:"
