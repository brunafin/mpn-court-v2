  ...
  return (
    <div className="h-screen">
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
        ...
        <h3 className="text-lg font-semibold mb-4 text-neutral-800">Em breve</h3>
        <p className="text-neutral-600 mb-6 text-center">Você vai poder editar as informações em breve.</p>
        ...
        <button
          className="px-4 py-2 bg-secondary-500 text-white rounded hover:bg-secondary-600 transition"
