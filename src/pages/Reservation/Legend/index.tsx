import { BsCashCoin, BsEyedropper, BsX } from "react-icons/bs";
...
function Legend({ setStatusSelected, statusSelected, isOpen }: LegendProps) {
  return (
    <div className="bg-neutral-900">
      <div
        className={`bg-neutral-900 items-center text-neutral-100 justify-center p-2 pb-0 ${
          isOpen ? "flex" : "hidden md:flex bg-neutral-900"
        }"`}
      >
        <p>Selecione um status para filtrar</p>
      </div>
      <ul
        className={`bg-neutral-900 flex p-3 items-center gap-2 md:gap-8 justify-start flex-wrap md:justify-center ${
