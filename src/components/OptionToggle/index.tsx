...
function OptionToggle({
  ...
  return (
    <label
      htmlFor={inputId}
      className={`mpn-tap flex min-h-14 cursor-pointer items-center justify-between gap-3 rounded-xl px-3.5 py-3 transition focus-within:ring-2 focus-within:ring-accent-blue/70 ${
        checked
